...
<TabsContent value="interview">
    ...
    1. What is flex and why is it useful in CSS layouts?
    2. Explain the main axis and cross axis in Flexbox.
    3. What are the main properties for the parent (container) element in Flexbox?
    4. What are the main properties for the child (flex item) elements in Flexbox?
    5. Explain the difference between justify-content and align-items in Flexbox.
    6. What is the purpose of the flex-grow, flex-shrink, and flex-basis properties in Flexbox?
    7. How can you center an element both horizontally and vertically using flex?
    8. What is the use of the flex-wrap property in Flexbox?
    9. Explain the align-self property in Flexbox and how it differs from align-items.
    10. How can you create a responsive layout using Flexbox?
    11. How does CSS Flex differ from CSS Grid Layout?
    12. Explain the order property in Flexbox and how it affects the order of flex items.
