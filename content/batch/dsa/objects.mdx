...
- 🗝️ Understand the concept of key-value pairs in objects.
- 🔄 Iterate over object properties.
- 🎛️ Work with nested objects and object methods.
...
<div className="w-full h-full">
    <VideoPlayer src="https://youtube.com/live/pYTNGZERlQY"/>

<Callout type="info">
    We hope that you found the tutorial video helpful in understanding the basic concepts of objects in javascript, You can refer this notes 📝 for quick revision.
</Callout>
