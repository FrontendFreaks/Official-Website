...
<div className="w-full h-full">
  <VideoPlayer src="https://youtu.be/ATKPTiZgT3Q"/>

  <Callout type="info">
    We hope that you found the tutorial video helpful in understanding the Linked List Data Structure, You can refer this notes 📝 for quick revision.
  </Callout>
...
<Callout type="info">
    You can find solutions of all these problems in [this playlist](https://www.youtube.com/playlist?list=PLSH9gf0XETourRyZW56Rdh9e0Phx-AJM5)
