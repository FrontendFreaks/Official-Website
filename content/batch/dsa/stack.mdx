...
<div className="w-full h-full">
  <VideoPlayer src="https://youtu.be/6RbtTNUTKVU"/>

  <Callout type="info">
    We hope that you found the tutorial video helpful in understanding the Stack Data Structure, You can refer this notes 📝 for quick revision.
  </Callout>
...
<Callout type="info">
  You can find solutions of all these problems in [this playlist](https://www.youtube.com/playlist?list=PLSH9gf0XETotSpywVcJGIYODBNL_j0P0u)
