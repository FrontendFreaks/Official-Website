...
<div className="w-full h-full">
    <VideoPlayer src="https://www.youtube.com/watch?v=Unc365YFdf4"/>

<Callout type="info">
    We hope that you found the tutorial video helpful in understanding the basic concepts of Strings in javascript, You can refer this notes 📝 for quick revision.
</Callout>
