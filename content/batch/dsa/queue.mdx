...
<div className="w-full h-full">
  <VideoPlayer src="https://youtu.be/Pq_D3wiN4k8"/>

  <Callout type="info">
    We hope that you found the tutorial video helpful in understanding the Queue Data Structure, You can refer this notes 📝 for quick revision.
  </Callout>
